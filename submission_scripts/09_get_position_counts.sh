...
OUTPUT_DIR=$(date +position_count_%Y_%m_%d_%H_%M) ### Changed
...
python pileup_snp_filtering.py \
    ./$OUTPUT_DIR/output_data/nv5.tsv \
    $DARMOR_NUM \
    $CABRIOLET_NUM \
...
python pileup_snp_filtering.py \
    ./$OUTPUT_DIR/output_data/v510.tsv \
    $DARMOR_NUM \
    $CABRIOLET_NUM \
