...
if __name__ == '__main__':
    ...
    output_file_hook.write('\t'.join(['chromosome',
        'position', 'reference_parent_allele', 'other_parent_allele',
        'reference_parent_depth', 'other_parent_depth', 'bulk1_depth',
        'bulk2_depth', 'bulk1_snp_index', 'bulk2_snp_index',
        'delta_snp_index']) + '\n')
                ...
                if (return_major_allele_freq(ref_par_reads_list) >=
                    ...
                    if not ref_allele == oth_allele:
                        ...
                        if (bulk1_snp_idx >= min_snp_idx or
                            ...
                            output_file_hook.write('\t'.join([str(val) for val in [chromosome,
                                position, ref_allele, oth_allele,
                                ref_par_depth, oth_par_depth, bulk1_depth,
                                bulk2_depth, bulk1_snp_idx, bulk2_snp_idx,
                                bulk1_snp_idx - bulk2_snp_idx]]) + '\n')
